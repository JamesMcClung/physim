...
public class Wind implements Force {
	...
	/**
	 * Creates a new wind. Air density and drag coefficients default 
	 * to {@link #EARTH_ATMOSPHERIC_DENSITY} and {@link #DRAG_COEFFICIENT_SPHERE}, respectively.
	 * @param windSpeed wind speed [m/s]. Can be null.
	 */
	...
	/**
	 * Creates a new stationary wind. Air density and drag coefficients default 
	 * to {@link #EARTH_ATMOSPHERIC_DENSITY} and {@link #DRAG_COEFFICIENT_SPHERE}, respectively.
	 */
	public Wind() {
		this(null);
	...
	public void setStrength(double airDensity, double dragCoef) {
	 ...
	 /**
	  * Strength is the coefficient used in calculating force.
	...
	protected Vector fp = new CVector(0,0,0); // force on particle p (recycled)
	@Override
